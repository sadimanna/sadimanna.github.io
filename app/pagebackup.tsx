                    ...
                    <div className="space-y-4">
                      <div className="bg-white rounded-lg border border-green-200 p-4 hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <h5 className="text-base font-semibold text-gray-900">Indian Statistical Institute</h5>
                            {/* <p className="text-sm text-gray-700 font-medium">Indian Statistical Institute</p> */}
                      ...
                      <div className="bg-white rounded-lg border border-green-200 p-4 hover:shadow-md transition-shadow">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <h5 className="text-base font-semibold text-gray-900">Indian Institute of Engineering Science and Technology</h5>
                            {/* <p className="text-sm text-gray-700 font-medium"> Indian Institute of Engineering Science and Technology</p>*/}
                            <p className="text-sm text-gray-600">Electronics and Telecommunication Engineering</p>
                            <p className="text-xs text-gray-500 mt-1">2014 - 2019</p>
                          </div>
                        </div>
                      </div>
                    </div>
